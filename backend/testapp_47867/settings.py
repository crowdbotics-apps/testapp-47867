"""
Django settings for testapp_47867 project.
...
ROOT_URLCONF = 'testapp_47867.urls'
...
WSGI_APPLICATION = 'testapp_47867.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_47867 API",
    "DESCRIPTION": "API documentation for testapp_47867 App",
    "VERSION": "v1",
}
